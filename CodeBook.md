...
<blockquote>
<h2>This description of the features has been sourced from the data file which is available from: http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones</h2>
